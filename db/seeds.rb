...
@mark = Guest.create!(name: 'Mark Jones', nights: 4)
GuestRoom.create!(guest:@mark, room: @room1)
...
GuestRoom.create!(guest:@mike, room: @room4)
GuestRoom.create!(guest:@mike, room: @room5)
GuestRoom.create!(guest:@matt, room: @room5)
GuestRoom.create!(guest:@matt, room: @room5)
GuestRoom.create!(guest:@mark, room: @room6)
GuestRoom.create!(guest:@mike, room: @room6)